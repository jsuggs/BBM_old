 ...
 */
class BBMPlayerProxy extends \BBM\Player implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'player_id', 'firstName', 'lastName', 'pitchingMatchupsAsPitcher', 'pitchingMatchupsAsBatter', 'battingPlays', 'pitchingPlays', 'throwingHand', 'battingHand', 'daateOfBirth');
    }
}